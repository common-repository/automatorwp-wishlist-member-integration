...
class AutomatorWP_WishList_Member_Remove_Level extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User gets removed from a level', 'automatorwp-wishlist-member-integration' ),
            'select_option'     => __( 'User gets <strong>removed</strong> from a level', 'automatorwp-wishlist-member-integration' ),
            /* translators: %1$s: Level. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User gets removed from %1$s %2$s time(s)', 'automatorwp-wishlist-member-integration' ), '{level}', '{times}' ),
            /* translators: %1$s: Level. */
            'log_label'         => sprintf( __( 'User gets removed from %1$s', 'automatorwp-wishlist-member-integration' ), '{level}' ),
            ...
            'options'           => array(
                'level' => array(
                    ...
                    'fields' => array(
                        'level' => array(
                            'name' => __( 'Level:', 'automatorwp-wishlist-member-integration' ),
                            'type' => 'select',
