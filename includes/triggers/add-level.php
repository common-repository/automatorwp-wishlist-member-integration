...
class AutomatorWP_WishList_Member_Add_Level extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User gets added to a level', 'automatorwp-wishlist-member-integration' ),
            'select_option'     => __( 'User gets <strong>added</strong> to a level', 'automatorwp-wishlist-member-integration' ),
            /* translators: %1$s: Level. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User gets added to %1$s %2$s time(s)', 'automatorwp-wishlist-member-integration' ), '{level}', '{times}' ),
            /* translators: %1$s: Level. */
            'log_label'         => sprintf( __( 'User gets added to %1$s', 'automatorwp-wishlist-member-integration' ), '{level}' ),
